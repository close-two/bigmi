...
function(e, t, n) {
    ...
    n(31),
    n(34),
    $("#J_downloadapp").css("position", "relative"),
    $("#J_downloadapp").append('<span class="box" style="width:124px;position: absolute; top: 40px;left: 50%;padding: 18px 0 14px;background: #fff;margin-left: -55px; box-shadow: #aaa 0px 1px 5px;display:none;"><em style="width:0;height:0;border-width:0 10px 10px;border-style:solid;border-color:transparent transparent #fff;position:absolute;top:-10px;left:50px;"></em><img src="//i1.mifile.cn/f/i/17/appdownload/download.png?1" alt="小米商城" width="90" height="90" style="display:block;margin: 0 auto;"><span style="display:block;text-align: center;font-size:14px;color:#333;line-height:1;margin-top:14px;">小米商城APP</span></span>'),
    $("#J_downloadapp").on("mouseenter",
    function() {
        $("#J_downloadapp").find(".box").show()
    }).on("mouseleave",
    function() {
        $("#J_downloadapp").find(".box").hide()
    });
    var i = /.t.n.|.test./;
    window.orderApiSite = i.test(window.location.host) ? "//api-order.test.mi.com": "//api.order.mi.com"
},
function(e, t, n) {
    var i, r; !
    function(t, n) {
    ...
    function(n, o) {
        ...
        function I(e) {
            var t = ye,
            n = it[e];
            return n || (n = A(e, t), "none" !== n && n || (nt = (nt || ce("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (nt[0].contentWindow || nt[0].contentDocument).document, t.write(), t.close(), n = A(e, t), nt.detach()), it[e] = n),
            n
        }
        function M(e, t) {
            return {
        ...
        function $(e, t) {
            ...
            i.style && (o[a] = ce._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && $e(i) && (o[a] = ce._data(i, "olddisplay", I(i.nodeName)))) : (r = $e(i), (n && "none" !== n || !r) && ce._data(i, "olddisplay", r ? n: ce.css(i, "display"))));
            for (a = 0; s > a; a++) i = e[a],
        ...
        function j(e, t, n, i, r) {
            for (var o = n === (i ? "border": "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += ce.css(e, n + Ne[o], !0, r)),
            i ? ("content" === n && (a -= ce.css(e, "padding" + Ne[o], !0, r)), "margin" !== n && (a -= ce.css(e, "border" + Ne[o] + "Width", !0, r))) : (a += ce.css(e, "padding" + Ne[o], !0, r), "padding" !== n && (a += ce.css(e, "border" + Ne[o] + "Width", !0, r)));
            return a
        }
        function D(e, t, n) {
            var i = !0,
        ...
        function J(e, t, n) {
            ...
            1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = ce.css(e, "display"), u = "none" === l ? ce._data(e, "olddisplay") || I(e.nodeName) : l, "inline" === u && "none" === ce.css(e, "float") && (ae.inlineBlockNeedsLayout && "inline" !== I(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        function U(e, t, n) {
            ...
            u = l.props;
            for (H(u, l.opts.specialEasing); a > o; o++) if (i = Ct[o].call(l, e, u, l.opts)) return i;
            return ce.map(u, P, l),
        ...
        var pe = function(e) {
            function t(e, t, n, i) {
                ...
                if ((t ? t.ownerDocument || t: J) !== $ && N(t), t = t || $, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s) return n;
                if (!i && j) {
                    if (11 !== s && (r = ye.exec(e))) if (a = r[1]) {
                        ...
                        n;
                        if ((a = r[3]) && x.getElementsByClassName) return K.apply(n, t.getElementsByClassName(a)),
                        n
                    }
                    if (x.qsa && (!D || !D.test(e))) {
            ...
            function p(e, t, n) {
                ...
                function(t, n, o) {
                    ...
                    if (a) {
                        ...
                        if (c = t[P] || (t[P] = {}), (s = c[i]) && s[0] === H && s[1] === o) return l[2] = s[2];
            ...
            try {
                K.apply(Q = Z.call(J.childNodes), J.childNodes),
            ...
            N = t.setDocument = function(e) {
                ...
                return i !== $ && 9 === i.nodeType && i.documentElement ? ($ = i, L = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), j = !k(i), x.attributes = r(function(e) {
                ...
                R = [], D = [], (x.qsa = ve.test(i.querySelectorAll)) && (r(function(e) {
                    ...
                    D.push(",.*:")
                })), (x.matchesSelector = ve.test(B = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && r(function(e) {
                    x.disconnectedMatch = B.call(e, "div"),
                    B.call(e, "[s!='']:x"),
                    R.push("!=", ae)
                }), D = D.length && new RegExp(D.join("|")), R = R.length && new RegExp(R.join("|")), t = ve.test(L.compareDocumentPosition), O = t || ve.test(L.contains) ?
                function(e, t) {
                ...
                function(e, t) {
                    ...
                    return n ? n: (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === J && O(J, e) ? -1 : t === i || t.ownerDocument === J && O(J, t) ? 1 : I ? ee(I, e) - ee(I, t) : 0 : 4 & n ? -1 : 1)
                }: function(e, t) {
                    if (e === t) return M = !0,
                    0;
                    var n, r = 0,
                    ...
                    for (; c[r] === l[r];) r++;
                    return r ? a(c[r], l[r]) : c[r] === J ? -1 : l[r] === J ? 1 : 0
                },
                i) : $
            },
            ...
            t.matchesSelector = function(e, n) {
                if ((e.ownerDocument || e) !== $ && N(e), n = n.replace(de, "='$1']"), !(!x.matchesSelector || !j || R && R.test(n) || D && D.test(n))) try {
                    var i = B.call(e, n);
            ...
            t.attr = function(e, t) { (e.ownerDocument || e) !== $ && N(e);
                        ...
                        function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [a ? m.firstChild: m.lastChild], a && y) {
                                    for (u = m[P] || (m[P] = {}), l = u[e] || [], p = l[0] === H && l[1], f = l[0] === H && l[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                        u[e] = [H, p, f];
                                        break
                                    }
                                } else if (y && (l = (t[P] || (t[P] = {}))[e]) && l[0] === H) f = l[1];
                                else for (; (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++f || (y && ((d[P] || (d[P] = {}))[e] = [H, f]), d !== t)););
                                return f -= r,
                                f === i || f % i === 0 && f / i >= 0
                            }
                        }
            ...
            S = t.select = function(e, t, n, i) {
                ...
                return (l || E(e, d))(i, t, !j, n, be.test(e) && u(t.parentNode) || t),
                n
            },
            x.sortStable = P.split("").sort(W).join("") === P,
        ...
        function(e, t) {
            ce.fn[e] = function(n, i) {
                ...
                this.length > 1 && (Ce[e] || (r = ce.unique(r)), xe.test(e) && (r = r.reverse())),
                this.pushStack(r)
            }
        });
        var Te = /\S+/g,
        ...
        ce.extend({
            ...
            ready: function(e) {
                if (e === !0 ? !--ce.readyWait: !ce.isReady) {
                    ...
                    ce.isReady = !0,
                    e !== !0 && --ce.readyWait > 0 || (_e.resolveWith(ye, [ce]), ce.fn.triggerHandler && (ce(ye).triggerHandler("ready"), ce(ye).off("ready")))
                }
            }
        }),
        ce.ready.promise = function(e) {
            if (!_e) if (_e = ce.Deferred(), "complete" === ye.readyState) setTimeout(ce.ready);
        ...
        Le = ce.access = function(e, t, n, i, r, o, a) {
            var s = 0,
            c = e.length,
            l = null == n;
            if ("object" === ce.type(n)) {
        ...
        ce.event = {
            ...
            trigger: function(e, t, i, r) {
                ...
                r || !l.trigger || l.trigger.apply(i, t) !== !1)) {
                    if (!r && !l.noBubble && !ce.isWindow(i)) {
                        for (c = l.delegateType || p, Oe.test(c + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s),
                        u = s;
            ...
            fix: function(e) {
                ...
                o = e,
                a = this.fixHooks[r];
                for (a || (this.fixHooks[r] = a = Be.test(r) ? this.mouseHooks: Re.test(r) ? this.keyHooks: {}), i = a.props ? this.props.concat(a.props) : this.props, e = new ce.Event(o), t = i.length; t--;) n = i[t],
                e[n] = o[n];
        ...
        ce.extend({
            clone: function(e, t, n) {
                ...
                if (t) if (n) for (s = s || w(e), i = i || w(o), a = 0; null != (r = s[a]); a++) E(r, i[a]);
                else E(e, o);
                return i = w(o, "script"),
                i.length > 0 && _(i, !c && w(e, "script")),
                i = s = r = null,
                o
            },
        ...
        ce.fn.extend({
            ...
            remove: function(e, t) {
                for (var n, i = e ? ce.filter(e, this) : this, r = 0; null != (n = i[r]); r++) t || 1 !== n.nodeType || ce.cleanData(w(n)),
                n.parentNode && (t && ce.contains(n.ownerDocument, n) && _(w(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
            ...
            html: function(e) {
                ...
                function(e) {
                    ...
                    if (! ("string" != typeof e || Ye.test(e) || !ae.htmlSerialize && Ue.test(e) || !ae.leadingWhitespace && Fe.test(e) || Ze[(ze.exec(e) || ["", ""])[1].toLowerCase()])) {
                        ...
                        try {
                            for (; i > n; n++) t = this[n] || {},
                            1 === t.nodeType && (ce.cleanData(w(t, !1)), t.innerHTML = e);
                            t = 0
                        } catch(r) {}
                    }
            ...
            domManip: function(e, t) {
                ...
                if (l && (s = ce.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                    for (o = ce.map(w(s, "script"), T), r = o.length; l > c; c++) i = s,
                    c !== d && (i = ce.clone(i, !0, !0), r && ce.merge(o, w(i, "script"))),
                    t.call(this[c], i, c);
        ...
        ce.extend({
            ...
            css: function(e, t, n, i) {
                var r, o, a, s = ce.camelCase(t);
                return t = ce.cssProps[s] || (ce.cssProps[s] = N(e.style, s)),
        ...
        function(e, t) {
            ce.cssHooks[t] = {
                ...
                set: function(e, n, i) {
                    var r = i && rt(e);
                    return L(e, n, i ? j(e, t, i, ae.boxSizing && "border-box" === ce.css(e, "boxSizing", !1, r), r) : 0)
                }
            }
        }),
        ...
        function(e, t) {
            ce.cssHooks[e + t] = {
                expand: function(n) {
                    for (var i = 0,
                    r = {},
                    o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Ne[i] + t] = o[i] || o[i - 2] || o[0];
                    return r
                }
            },
            at.test(e) || (ce.cssHooks[e + t].set = L)
        }),
        ce.fn.extend({
            css: function(e, t) {
                return Le(this,
        ...
        ce.extend({
            ...
            removeAttr: function(e, t) {
                ...
                ce.expr.match.bool.test(n) ? Mt && It || !At.test(n) ? e[i] = !1 : e[ce.camelCase("default-" + n)] = e[i] = !1 : ce.attr(e, n, ""),
        ...
        Et = {
            set: function(e, t, n) {
                return t === !1 ? ce.removeAttr(e, n) : Mt && It || !At.test(n) ? e.setAttribute(!It && ce.propFix[n] || n, n) : e[ce.camelCase("default-" + n)] = e[n] = !0,
                n
            }
        },
        ...
        ce.fn.extend({
            addClass: function(e) {
                ...
                if (l) for (t = (e || "").match(Te) || []; c > s; s++) if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Lt, " ") : " ")) {
        ...
        try {
            ...
            Ot = ye.createElement("a"),
            Ot.href = "",
            Ot = Ot.href
        }
        Bt = zt.exec(Ot.toLowerCase()) || [],
        ce.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function(e, t) {
                ...
                o = d.url,
                d.hasContent || (d.data && (o = d.url += (Dt.test(o) ? "&": "?") + d.data, delete d.data), d.cache === !1 && (d.url = Jt.test(o) ? o.replace(Jt, "$1_=" + jt++) : o + (Dt.test(o) ? "&": "?") + "_=" + jt++)),
                d.ifModified && (ce.lastModified[o] && x.setRequestHeader("If-Modified-Since", ce.lastModified[o]), ce.etag[o] && x.setRequestHeader("If-None-Match", ce.etag[o])),
                (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && x.setRequestHeader("Content-Type", d.contentType),
                x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Yt + "; q=0.01": "") : d.accepts["*"]);
...
function(e, t, n) {
    ...
    MI.setLoginInfo = {
            ...
            this.miid && 0 !== this.miid && this.miidLink ? (this.data.userName = this.miid ? $.cookie("XM_" + this.miid + "_UN") : "", this.data.goodsNum = $.cookie("xm_user_www_num"), this.data.goodsNum = null == this.data.goodsNum ? 0 : this.data.goodsNum, null == this.data.userName || "" === this.data.userName ? t.createScript(this.miid) : this.updateDom(this.miid)) : $.ajax({
                ...
                success: function(e) {
                    if (!e.cUserId) {
                        ...
                        MI.GLOBAL_CONFIG && MI.GLOBAL_CONFIG.orderSite && (n = MI.GLOBAL_CONFIG.orderSite + "/site/login?redirectUrl=" + encodeURI(location.href)),
        ...
        createScript: function(e) {
            var t = /.t.n.|.test./,
            n = t.test(window.location.host) ? "http://account.preview.n.xiaomi.net": "https://account.xiaomi.com",
            i = document.createElement("script");
            i.src = n + "/pass/userInfoJsonP?userId=0&callback=setLoginInfo_getAccountInfo",
    ...
    window.setLoginInfo_getAccountInfo = function(e) {
        ...
        if (e.userId) {
            ...
            $.cookie("XM_" + e.userId + "_UN", t.data.userName, n),
...
function(e, t, n) { (function(e, i) {
        ...
        function O(e, t, n, i, r) {
            return r || B(e, t, n, 4, 3.4028234663852886e38, -3.4028234663852886e38),
            Q.write(e, t, n, i, 23, 4),
            n + 4
        }
        function P(e, t, n, i, r) {
            return r || B(e, t, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
        ...
        e.prototype.writeUInt32LE = function(t, n, i) {
            ...
            e.TYPED_ARRAY_SUPPORT ? (this[n + 3] = t >>> 24, this[n + 2] = t >>> 16, this[n + 1] = t >>> 8, this[n] = 255 & t) : R(this, t, n, !0),
            n + 4
        },
        e.prototype.writeUInt32BE = function(t, n, i) {
            ...
            n = 0 | n,
            i || j(this, t, n, 4, 4294967295, 0),
            e.TYPED_ARRAY_SUPPORT ? (this[n] = t >>> 24, this[n + 1] = t >>> 16, this[n + 2] = t >>> 8, this[n + 3] = 255 & t) : R(this, t, n, !1),
            n + 4
        },
        ...
        e.prototype.writeInt32LE = function(t, n, i) {
            ...
            e.TYPED_ARRAY_SUPPORT ? (this[n] = 255 & t, this[n + 1] = t >>> 8, this[n + 2] = t >>> 16, this[n + 3] = t >>> 24) : R(this, t, n, !0),
            n + 4
        },
...
function(e, t, n) {
    ...
    jQuery(function(e) {
        ...
        function i() {
            var menu = e("#J_navCategory");
			var Div = e(".site-category");
          ...
          //  "undefined" != typeof isCategoryToggled && "toggled" === isCategoryToggled ? r.show() : 
		  
            var childMenu = $(menu).find(".category-item")
			childMenu.on({
                mouseenter: function() {
                    e(this).addClass("category-item-active")
                },
                mouseleave: function() {
                    e(this).removeClass("category-item-active")
                }
            })
        }
        function r() {
...
function(e, t) {
    ...
    e.exports = function(e) {
        ...
        o = n.length - 1; o > r;) {
            ...
            t += '> <a class="link" href="' + s.url + '"><img class="thumb" src="//i1.mifile.cn/f/i/2014/cn/placeholder-40.png" data-src="' + s.img + '?width=80&height=80" width="40" height="40" alt="" /><span class="text">' + s.title + "</span></a> ",
        ...
        if (a.length) {
            ...
            c.on({
                focus: function() {
                    ...
                    !e(this).val() && u.defaultWords && t(u.defaultWords)
                },
                blur: function() {
                    "" === e.trim(c.val()) && e(".search-hot-words").fadeIn(200),
                ...
                keyup: function(i) {
                    0 === e.trim(e(this).val()).length && u.defaultWords && (f = null, t(u.defaultWords)),
                    n(i.which),
                    clearTimeout(h),
                    40 !== i.which && 38 !== i.which && (h = setTimeout(function() {
                        f = c.val(),
                        r(f)
                    },
                    d))
        ...
        if (e && "function" == typeof t) {
            ...
            $.ajax({
                ...
                error: function(e, t, n) {
                    var o = i ? i: {};
                    o.locationHref = window.location.href,
                    o.errorData = e,
                    o.errorType = t,
                    o.error = n,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(r), JSON.stringify(o)])
                },
                success: function(i) {
                    var r = function() {
...
function(module, exports, __webpack_require__) {
    ...
    MI.bigtap = {
        ...
        getHdInfo: function() {
            ...
            $.ajax({
                ...
                error: function(t, n, i) {
                    ...
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(o), JSON.stringify(r)]),
                    e.getInfoError()
                },
                success: function(t) {
        ...
        getMode: function() {
            ...
            if ("1" === e.config.modeType) {
                ...
                error: function(n, i, r) {
                    ...
                    o.errorType = i,
                    o.error = r,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(t), JSON.stringify(o)]),
                    e.getmodeError()
                },
                success: function(t) {
        ...
        checkMode: function(e) {
            ...
            a.length > 50 ? u() : (n.html(o), c.addClass("btn-gray"), $.ajax({
                ...
                error: function(e, i, o) {
                    ...
                    s.locationHref = window.location.href,
                    s.errorData = e,
                    s.errorType = i,
                    s.error = o,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(l), JSON.stringify(s)]),
                    n.html(r),
                    "5" === t.config.modeType && t.getMode()
                },
                success: function(e) {
        ...
        beforeHdget: function() {
            ...
            e.config.salt && e.config.jssignUrl ? $.ajax({
                ...
                error: function(t, n, i) {
                    ...
                    r.errorType = n,
                    r.error = i,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(e.config.jssignUrl), JSON.stringify(r)]),
                    e.getHdget()
                },
                success: function() {
        ...
        getHdget: function() {
            ...
            $.ajax({
                ...
                error: function(t, i, r) {
                    ...
                    o.errorType = i,
                    o.error = r,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(n), JSON.stringify(o)]),
                    e.inTheQueue ? (e.stopQueue(), void $(e.config.modalError).modal({
                        show: !0,
                        backdrop: "static"
                    }).removeClass("hide")) : !1
                },
                success: function(t) {
                    ...
                    if (!e.inTheQueue) return ! 1;
                    if (t.login === !1 && (location.href = MI.GLOBAL_CONFIG.orderSite + "/site/login?redirectUrl=" + location.href), r === !0) return e.stopQueue(),
                    e.showSoldout(a),
                    "function" == typeof e.config.overCallback && e.config.overCallback(e.config.obj),
                    !1;
                    if (e.getHdgetTimer && clearTimeout(e.getHdgetTimer), i) e.getShopCart(i);
                    else {
                        if ("flashsale_bigtap" === e.config.sourceVal && n[e.config.gid].max) return e.stopQueue(),
                        void MI.alert({
                            msg: "闪购已超上限"
                        });
        ...
        getShopCart: function(e) {
            ...
            i = {
                source: t.config.addcartSource ? t.config.addcartSource: t.config.sourceVal,
                token: e
            };
            t.config.timeField && (i.timeField = t.config.timeField),
            $.ajax({
                type: "GET",
                url: n,
                dataType: "jsonp",
                ...
                error: function(i, r, o) {
                    ...
                    a.locationHref = window.location.href,
                    a.errorData = i,
                    a.errorType = r,
                    a.error = o,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(n), JSON.stringify(a)])
                },
                success: function(e) {
                    return t.stopQueue(),
        ...
        showSoldout: function(e) {
            ...
            s = function() {
                $("body").append(o(a)),
                $(t.config.modalSoldout).modal("show").one("hidden.bs.modal",
                function() {
                    $(this).remove()
                })
            };
            $(t.config.modalSoldout).length && $(t.config.modalSoldout).remove(),
            e && e.title && e.des && (a.title = e.title, a.desc = e.des),
            s(),
            $.ajax({
                url: n,
                dataType: "jsonp",
                ...
                error: function(e, t, i) {
                    ...
                    r.errorType = t,
                    r.error = i,
                    _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(n), JSON.stringify(r)]),
                    s()
                },
                success: function(e) {
        ...
        mi6Sign: function(d) {
            if (/^eval/.test(d.s)) return eval(d.s),
            d.w ? eval(d.w) || "": "";
            if (/^var/.test(d.s)) return eval(d.s),
            d.w ? eval(d.w) || "": "";
