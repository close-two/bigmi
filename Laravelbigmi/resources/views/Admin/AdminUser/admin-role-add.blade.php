...
<article class="page-container">
	<form action="/roles" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
					...
					<dd>
						<dl class="cl permission-list2">
							...
							@foreach($value as $rows)
								<label class="">
									<input type="checkbox" value="{{$rows->id}}" name="nid[]" id="user-Character-1-0-0" >
									{{$rows->operate}}</label>
							@endforeach
							</dd>
						</dl>
		...
		<div class="row cl">
			...
			{{csrf_field()}}
				<button type="submit" class="btn btn-success radius" id="admin-role-save" name="admin-role-save"><i class="icon-ok"></i> 添加</button>
			</div>
		</div>
	</form>
</article>
