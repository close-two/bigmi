...
<div class="page-container">
	<form action="/adminads" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>广告标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="adsname">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				否:<input type="radio" checked size="30%" value="0" class="input-text" placeholder="" id="" name="status">
				是:<input type="radio" size="30%"  class="input-text" value="1" placeholder="" id="" name="status">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">广告简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="comment" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">	
		<input type="file" class="btn btn-success" onchange="fileChange(this);"  name="file">
		</div>
...
<script type="text/javascript">
    ...
    function fileChange(target,id) {
        ...
        if(filepath){
            ...
            if(!isnext){
                alert("不接受此文件类型！请上传jpg.png.jpeg.git格式的广告图片");
                target.value ="";
                return false;
            }
        }else{
