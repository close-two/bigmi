...
<div class="page-container">
	<form action="/adminads/{{$ads->id}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>广告标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$ads->adsname}}" placeholder="" id="" name="adsname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>广告来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$ads->source}}" placeholder="" id="" name="source">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="comment" cols="" rows="" class="textarea"  placeholder="" value="{{$ads->comment}}" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{$ads->comment}}</textarea>
		...
		<div class="row cl">
        <img src="{{$ads->file}}" width="100px" height="100px" alt="">	
		<input type="file" onchange="fileChange(this);" class="btn btn-success"  name="file">
		</div>
