...
<div class="page-container">
	<form action="/goods/{{$goodslist->id}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    {{csrf_field()}}
    {{method_field('PUT')}}
		<div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品名字：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_title}}" placeholder="" id="" name="goods_title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_descr}}" placeholder="" id="" name="goods_descr">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">销售描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_sale_descr}}" placeholder="" id="" name="goods_sale_descr">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品市场价：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_market_price}}" placeholder="" id="" name="goods_market_price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品销售价：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_shop_price}}" placeholder="" id="" name="goods_shop_price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品总销量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_sale_count}}" placeholder="" id="" name="goods_sale_count">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品库存：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$goodslist->goods_stock}}" placeholder="" id="" name="goods_stock">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <select name="goods_status" class="select">
                    <option value="0" {{$goodslist->goods_status==0?'selected':''}}>下架</option>
                    <option value="1" {{$goodslist->goods_status==1?'selected':''}}>上架</option>
                </select>
                </span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                @foreach($type as $row)
                    <option value="{{$row->id}}" {{$goodslist->cate_id==$row->id?"selected":""}}>{{$row->catename}}</option>
                @endforeach
                </select>
                </span>
            </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">主图上传</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="" onchange="changepic(this)"  value="" name="goods_img">
                <div><img src="{{$goodslist->goods_img}}" id="show" width="200"></div>
            </div>
        </div> 
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">缩略图上传</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="" onchange="changepic1(this)"  value="" name="goods_thums">
                <div><img src="{{$goodslist->goods_thums}}" id="show1" width="200"></div>
            </div>
        </div> 
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" name="goods_detail" style="width:100%;height:500px;"></script>
            </div>
        </div>
        <div class="row cl">
