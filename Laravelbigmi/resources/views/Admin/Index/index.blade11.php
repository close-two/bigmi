			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="/adminlogout">切换账户</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="/admin" data-title="品牌管理" href="javascript:;">品牌管理</a></li>
	...
	<dl id="menu-picture">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/adminpic/create" data-title="添加轮播图" href="javascript:void(0)"> 添加轮播图</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="/admin" data-title="会员列表" href="javascript:;">会员列表</a></li>
					<li><a data-href="/admin" data-title="品牌管理" href="javascript:;">品牌管理</a></li>
		...
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a data-href="/charts-1.html" data-title="分类列表" href="javascript:void(0)">分类列表</a></li>
					<li><a data-href="/charts-2.html" data-title="添加分类" href="javascript:void(0)">添加分类</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a data-href="/system-base.html" data-title="订单列表" href="javascript:void(0)">订单列表</a></li>
					<li><a data-href="/system-category.html" data-title="添加订单" href="javascript:void(0)">添加订单</a></li>
			</ul>
		</dd>
	</dl>
</div>
