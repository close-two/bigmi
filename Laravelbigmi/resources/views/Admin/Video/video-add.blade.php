...
@if (count($errors) > 0)
    <div class="mws-form-message error">
        <div class="alert alert-danger " id="show">
            <ul >
...
<div class="page-container">
	<form action="/adminvideo" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>视频标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('videoname')}}" placeholder="" id="" name="videoname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>视频来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('source')}}" placeholder="" id="" name="source">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否显示：</label>
			<div class="formControls col-xs-8 col-sm-9">
				否:<input type="radio" checked  value="0" class="input-text" placeholder="" id="" name="status">
				是:<input type="radio"  class="input-text" value="1" placeholder="" id="" name="status">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">视频简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="comment" cols="" rows="" maxlength="300" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{old('comment')}}</textarea>
		...
		<div class="row cl">	
		<input type="file"  onchange="fileChange(this);" class="btn btn-success"  name="video">
		</div>
...
$(function(){
	...
	uploader.on( 'fileQueued', function( file ) {
		var $li = $(
			'<div id="' + file.id + '" class="item">' +
				'<div class="pic-box"><img name="file"></div>'+
	...
	uploader.on( 'uplovideouccess', function( file ) {
...
<script type="text/javascript">
    ...
    function fileChange(target,id) {
        var fileSize = 0;
        var filetypes =[".mp4",".wmv",".avi",".mpeg"];
        ...
        if(filepath){
            ...
            if(!isnext){
                alert("不接受此文件类型！请上传.mp4,.wmv,.avi,.mpeg格式的视频");
                target.value ="";
                return false;
            }
        }else{
