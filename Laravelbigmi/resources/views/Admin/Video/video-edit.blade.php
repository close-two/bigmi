...
<div class="page-container">
	<form action="/adminvideo/{{$video->id}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>视频标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$video->videoname}}" placeholder="" id="" name="videoname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>视频来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$video->source}}" placeholder="" id="" name="source">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="comment" cols="" rows="" class="textarea"  placeholder="{{$video->comment}}" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{$video->comment}}</textarea>
		...
		<div class="row cl">
        <a style="color:blue;" class="btn btn-default" href="{{$video->video}}">{{$video->videoname}}(原视频)</a>	
		<input type="file" class="btn btn-success"  name="video">
		</div>
