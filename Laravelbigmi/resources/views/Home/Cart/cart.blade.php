        ...
        @if(!empty($data1))
         ...
         <div class="item-row  clearfix  gb">
          ...
          <div class="col col-num" style="width: 200px"> 
           ...
           <!-- 加减 -->
            <a href="#" class="btn btn-info jian" sid="{{$row['id']}}">-</a><input class="num" tyep="text" value="{{$row['num']}}" style="width: 53px"><a href="#" class="btn btn-info jia" sid="{{$row['id']}}" style="width: 53px;float: left;">+</a><input type="hidden" class="stock" value="{{$row['stock']}}">
           </div>
          </div> 
          <div class="col col-total">
    ...
    $(".del").click(function(){
      ...
      if(ss){
        ...
        // var $res;
          ...
          //   str='<div class="item-table J_cartGoods" data-info="{ commodity_id:"1175100002", gettype:"buy", itemid:"2175100001_0_buy", num:"1"} "><input type="hidden" name="kc" value="'+$arr[i]["stoke"]+'"><div class="item-row  clearfix"><div class="col col-check"> <i class="iconfont icon-checkbox icon-checkbox-selected J_itemCheckbox" data-itemid="2180800006_0_buy" data-status="1">√</i></div> <div class="col col-img"> <a href="//item.mi.com/1180800006.html" target="_blank" data-stat-id="f75e15aec56f5109" onclick="_msq.push(["trackEvent", "5df97b551662ffe7-f75e15aec56f5109", "//item.mi.com/1180800006.html", "pcpid", ""]);"> <img alt="" src="'+$arr[i]["pic"]+'" width="80" height="80" /> </a> </div> <div class="col col-name">  <div class="tags"> </div> <div class="tags"> </div> <h3 class="name"> <a href="//item.mi.com/1180800006.html" target="_blank" data-stat-id="12b91f1022c62ec3" onclick="_msq.push(["trackEvent", "5df97b551662ffe7-12b91f1022c62ec3", "//item.mi.com/1180800006.html", "pcpid", ""]);">'+$arr[i]["name"]+'</a> </h3>  </div> <div class="col col-price">'+$arr[i]["price"]+'元 </div><div class="col col-num" style="width: 200px"> <div class="change-goods-num clearfix J_changeGoodsNum"> <a href="#" class="btn btn-info jian" uid="'+$arr[i]["id"]+'">-</a><input class="num" tyep="text" value="'+$arr[i]["num"]+'" style="width: 53px"><a href="#" class="btn btn-info jia" uid="'+$arr[i]["id"]+'id" style="width: 50px;float: left;">+</a></div></div> <div class="col col-total">'+$arr[i]["price"]*$arr[i]["num"]+'元 <p class="pre-info"> </p> </div> <div class="col col-action" id="1"><a uid="'+$arr[i]["id"]+'" type="submit" class="del btn btn-danger"><i class="iconfont"></i></a></div> </div></div>';
          //     $('.add').append(str);
              if($arr==1){
