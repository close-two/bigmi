   ...
   <div class="uc-content-box"> 
    ...
    <div class="box-bd"> 
     <div class="user-address-list J_addressList clearfix"> 
      ...
      <div class="address-item J_addressItem "  id="parent">
       ...
       <dl> 
        ...
        <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'" class="Hui-iconfont">&#xe6df;修改</a>
       </dl> 
...
<div class="info">
  ...
  <div>
    <form action="/useraddress/{{$address->id}}" method="post" onsubmit="return check()">
      ...
      {{csrf_field()}}
      {{method_field("PUT")}}
      详细地址: <input class="form-control" type="text" id="detailed" name="detailed" value="{{$address->detailed}}">
      <br>
      联系人: <input class="form-control" type="text" id="whoget" name="name" value="{{$address->name}}">
      <br>
      联系电话: <input class="form-control" type="text" id="phone" name="phone" value="{{$address->phone}}">
