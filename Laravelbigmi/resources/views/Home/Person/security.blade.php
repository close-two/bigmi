   ...
   <div class="wrap"> 
    <div class="layout bugfix_ie6 dis_none"> 
     <div class="n-logo-area clearfix"> 
      <a href="https://account.xiaomi.com/" class="fl-l"> <img src="static/homes/security/n-logo.png" srcset="/static/res/fa93d30/passport/acc-2014/img/n-logo.png 1x, /static/res/fb6d739/account-static/respassport/acc-2014/img/n-logo@2x.png 2x" /> </a> 
      ...
      <div class="n-account-area clearfix"> 
       ...
       <div class="na-img-area fl-l"> 
        ...
        <div class="na-img-bg-area">
         <img src="static/homes/security/CyzrpDCAz9G1hG_320.jpg" />
        </div> 
       </div> 
      </div> 
     </div> 
      ...
      <ul class="device-detail-area"> 
       <li id="changePassword" class="click-row"> 
        <div class="font-img-item clearfix"> 
         ...
         <span class="title-normal wap-desc dis_none_pc"> 修改 </span> 
         <i class="arrow_r"></i> 
        </div> 
        <div class="ada-btn-area" id="btnUpdatePassword"> 
         <a __href="/pass/changePassword?userId=1337447143" class="n-btn"> 修改 </a> 
        </div> </li> 
       <li id="changeEmail" class="click-row"> 
        <div class="font-img-item clearfix"> 
         ...
         <div class="item_column"> 
          ...
          <span class="title-normal wap-desc user_address"> hu*********n@1**.com </span> 
         </div> 
         <span class="title-normal wap-desc"> <span class="dis_none_pc">修改</span> </span> 
         <p class="font-default">安全邮箱可以用于登录小米帐号，重置密码或其他安全验证</p> 
         <i class="arrow_r"></i> 
        </div> 
        <div class="ada-btn-area" id="btnUpdateEmail"> 
         <!--正常状态--> 
         <a __href="/pass/bindAddress?userId=1337447143&amp;type=EM&amp;replace=true&amp;address=hu*********n@1**.com" class="n-btn">修改</a> 
        </div> </li> 
       <li id="changeMobile" class="click-row"> 
        <div class="font-img-item clearfix"> 
         ...
         <div class="item_column"> 
          ...
          <span class="title-normal wap-desc user_address"> <span class="phone-bind-adress" data-key="BA2641602DB2D3D0">188******25</span><span class="ph_list_sum phone-list-sum" data-title="等&lt;span class='ff6'&gt;{phsum}&lt;/span&gt;个"></span> </span> 
         </div> 
         <span class="title-normal wap-desc"> <span class="dis_none_pc">修改</span> </span> 
        ...
        <div class="ada-btn-area" id="btnUpdatePhone"> 
         <!--<a class="n-btn btnBindMobile" __href="/pass/bindAddress?userId=1337447143&type=PH&replace=false" class="n-btn" data-mode="add">
                绑定
              </a>--> 
         <a class="n-btn btnChangeMobile" __href="/pass/bindUserAddress?userId=1337447143&amp;type=PH" data-mode="update"> 修改 </a> 
        </div> </li> 
       <li id="setMibao" class="click-row"> 
        ...
        <div class="ada-btn-area" id="btnSetMibao"> 
         <a id="mibao_link" __href="https://sq.id.mi.com/setQuestion?userId=1337447143&amp;_locale=zh_CN" class="n-btn">修改</a> 
        </div> </li> 
      </ul> 
      <!--
     ...
     <div class="mod_tip_bd"> 
      <div class="wapbox"> 
       <div class="binding setbackphone"> 
        ...
        <div class="fixpos">
         <label class="input_bg"><input type="tel" class="backupPhoneInput" placeholder="请输入备用手机号码" autocomplete="off" disableautocomplete="" /></label>
        </div> 
       </div> 
       <div class="setbakphone_error"> 
        <div class="err_tip empty_phone err_tip_independ" _text="请输入备用手机">
         请输入备用手机
        </div> 
        <div class="err_tip wng_fmt err_tip_independ" _text="手机号码格式错误">
         手机号码格式错误
        </div> 
        <div class="err_tip sys_err err_tip_independ" _text="系统错误，请稍后再试">
         系统错误，请稍后再试
        </div> 
        <div class="err_tip dupl_phone err_tip_independ" _text="备用手机不能与安全手机相同">
         备用手机不能与安全手机相同
        </div> 
        <div class="err_tip set_fail err_tip_independ" _text="设置备用手机失败">
         设置备用手机失败
        </div> 
        <div class="err_tip bad_param err_tip_independ" style="display:none" _text="参数错误">
         参数错误
